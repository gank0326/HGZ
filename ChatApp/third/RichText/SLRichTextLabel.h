...
#import "NSMutableAttributedString+RichTextLabel.h"

@class SLRichTextLabelURL;

@interface SLRichTextLabel : UIView
@property (nonatomic, weak)    id <SLRichTextLabelDelegate> delegate;
...
//设置全局的自定义Link检测Block(详见SLRichTextLabelURL)
