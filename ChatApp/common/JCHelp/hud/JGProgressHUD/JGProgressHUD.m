...
#pragma clang diagnostic pop
    ...
    if (self.tipImageView) {
        labelFrame.size.width = labelFrame.size.width - CGRectGetWidth(_tipImageView.frame) - 40;
    }
    ...
    void (^updates)(void) = ^{
        ...
        if (self.tipImageView) {
            [_tipImageView setFrame:CGRectMake(25, CGRectGetHeight(labelFrame)/2 - CGRectGetHeight(_tipImageView.frame)/2 + 10, CGRectGetWidth(_tipImageView.frame), CGRectGetHeight(_tipImageView.frame))];
            _textLabel.frame = CGRectMake(CGRectGetMaxX(_tipImageView.frame)+4, CGRectGetMinY(labelFrame), CGRectGetWidth(labelFrame) - CGRectGetWidth(_tipImageView.frame), CGRectGetHeight(labelFrame));
        } else {
...
- (void)setTipImageView:(UIImageView *)tipImageView {
    if (self.tipImageView == tipImageView) {
        return;
    }
