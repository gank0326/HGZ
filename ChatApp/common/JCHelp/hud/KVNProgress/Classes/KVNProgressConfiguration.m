...
{
	if (self = [super init]) {
		_backgroundFillColor = [UIColor colorWithWhite:0.0f alpha:0.8f];
		_backgroundTintColor = [UIColor colorWithWhite:0.0f alpha:0.8f];
		...
		_circleSize = (_fullScreen) ? 90.0f : 40.0f;
		_lineWidth = 2.0f;
